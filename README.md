...
| `LinkedList`     | LinkedList<String> tractors = new LinkedList<String>();   |
| `HashMap`     | HashMap<String, String> capitals = new HashMap<String, String>();   |
| `HashSet`     | HashSet<String> planes = new HashSet<String>();   |      
